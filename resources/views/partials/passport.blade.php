<section class="passport" id="about" data-chapter="02" data-chapter-name="{{ __('site.chapters.paperwork') }}">
    <div class="passport__pin" id="passport-pin">
        ...
        <div class="pstage">
            <div class="pbook__shadow"></div>

            <div class="pbook" id="pbook">
                <div class="pbook__back"></div>
                ...
                <div class="pbook__fly">
                    <div class="pbook__fly-face pbook__fly-face--front"></div>
                    <div class="pbook__fly-face pbook__fly-face--back"></div>
                </div>
            ...
            <div class="ppen" aria-hidden="true">
                <span class="ppen__cap"></span>
                <span class="ppen__ring"></span>
                <span class="ppen__barrel"></span>
                <span class="ppen__grip"></span>
                <span class="ppen__nib"></span>
            </div>
        </div>
